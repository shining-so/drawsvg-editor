function edrawsvg() {
  var O = "bootstrap",
    ...
    Eb = "clear.cache.gif",
    Fb = "baseUrl",
    Gb = "edrawsvg.nocache.js",
    Hb = "base",
    Ib = "//",
    Jb = "selectingPermutation",
    Kb = "edrawsvg.devmode.js",
    Lb = "0BD2D91CF5F47B792B51F25CEBEADBA3",
    Mb = ":",
    Nb = ".cache.js",
    Ob = "link",
    Pb = "rel",
    ...
    Rb = "href",
    Sb = "loadExternalRefs",
    Tb = "gwt/chrome/chrome.css",
    Ub = "css/svg-app.css",
    Vb = "end",
    Wb = "http:",
    Xb = "file:",
    Yb = "_gwt_dummy_",
    Zb = "__gwtDevModeHook:edrawsvg",
    $b = "Ignoring non-whitelisted Dev Mode URL: ",
    _b = ":moduleBase";
  var o = window;
  var p = document;
  r(O, P);
  ...
  edrawsvg.__sendStats = r;
  edrawsvg.__moduleName = S;
  edrawsvg.__errFn = null;
  edrawsvg.__moduleBase = U;
  edrawsvg.__softPermutationId = V;
  edrawsvg.__computePropValue = null;
  edrawsvg.__getPropMap = null;
  edrawsvg.__installRunAsyncCode = function () {};
  edrawsvg.__gwtStartLoadingFragment = function () {
    return null;
  };
  edrawsvg.__gwt_isKnownPropertyValue = function () {
    return false;
  };
  edrawsvg.__gwt_getMetaProperty = function () {
    return null;
  };
  var s = null;
  var t = (o.__gwt_activeModules = o.__gwt_activeModules || {});
  t[S] = { moduleName: S };
  edrawsvg.__moduleStartupDone = function (e) {
    var f = t[S].bindings;
    t[S].bindings = function () {
      var a = f ? f() : {};
      var b = e[edrawsvg.__softPermutationId];
  ...
  function A(k) {
    ...
    edrawsvg.onScriptDownloaded = function (a) {
      l(function () {
        m(a);
      });
    };
    ...
    if (edrawsvg.__errFn) {
      n.onerror = function () {
        edrawsvg.__errFn(S, new Error(mb + code));
      };
    }
    p.getElementsByTagName(nb)[V].appendChild(n);
  }
  edrawsvg.__startLoadingFragment = function (a) {
    return D(a);
  };
  edrawsvg.__installRunAsyncCode = function (a) {
    var b = v();
    var c = b.body;
  ...
  function D(a) {
    ...
    return edrawsvg.__moduleBase + a;
  }
  function F() {
    var f = [];
    var g = V;
    ...
    edrawsvg.__getPropMap = function () {
      var a = {};
      for (var b in h) {
    ...
    edrawsvg.__computePropValue = j;
    o.__gwt_activeModules[S].bindings = edrawsvg.__getPropMap;
    r(O, Jb);
    if (q()) {
      return D(Kb);
    }
    ...
    try {
      ...
      var l = k.indexOf(Mb);
      if (l != -1) {
        g = parseInt(k.substring(l + W), eb);
        k = k.substring(V, l);
      }
    } catch (a) {}
    edrawsvg.__softPermutationId = g;
    return D(k + Nb);
  }
  function G() {
    ...
    function c(a) {
      if (!__gwt_stylesLoaded[a]) {
        var b = p.createElement(Ob);
        b.setAttribute(Pb, Qb);
        b.setAttribute(Rb, D(a));
  ...
  B();
  edrawsvg.__moduleBase = C();
  t[S].moduleBase = edrawsvg.__moduleBase;
  var H = F();
  if (o) {
    var I = !!(o.location.protocol == Wb || o.location.protocol == Xb);
